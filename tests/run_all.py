...
from tests import test_calibrate, test_reflect, test_audit, test_status, test_validate
...
def main():
    ...
    for module in [test_calibrate, test_reflect, test_audit, test_status, test_validate]:
